...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
            ...
            ['MemeHoovy', 'meme', 'Hscript maker and helper of Alt Engine','https://github.com/MemeHovy','FFFFFF'],
            ['Wither362', 'wither', 'Fix bugs and helper of Alt Engine','https://github.com/Wither362','FF0019'],
