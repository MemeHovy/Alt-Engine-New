...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [
			...
			[
				'Fearester',
				'fearester',
				'Main Coder of Alt Engine',
				'https://youtube.com/@fearester1282',
				'00BFFF'
			],
			[
				'StefanBETA2008',
				'stefan',
				'Coder of Alt Engine\n and Cool Man',
				'https://github.com/StefanBETA2008',
				'FFA500'
			],
			[
				'Rom4chek',
			...
			[
				'MemeHoovy',
				'meme',
				'Hscript maker and helper of Alt Engine',
			...
			[
				'Wither362',
				'wither',
				'Fix bugs and helper of Alt Engine',
	...
	inline function getCurrentBGColor()
	{
