...
class PlayState extends MusicBeatState
{
	...
	{
		sicksPercent = FlxMath.lerp(0 , (sicks / noteHit), CoolUtil.boundTo(elapsing * 9, 0, 1));
		goodsPercent = FlxMath.lerp(0 , (goods / noteHit), CoolUtil.boundTo(elapsing * 9, 0, 1));
